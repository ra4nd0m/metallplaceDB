...
module.exports.RusMonthStraight = ["Январб","Фервраль","Март","Апрель","Май","Июнь","Июль","Август","Сентябрь","Октябрь","Ноябрь","Декабрь"];
...
module.exports.FontSizeThExtraInfo = 9 * 2
