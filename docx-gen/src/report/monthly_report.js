                ...
                },
                {
                    ...
                    children: [
                       ...
                       paragraph({
                        ...
                        paragraph({ // mn руда
                            children: [await oneChartText(FormChartUrl(new ChartUrl([22], MedPriceId, GetNMonthRange(date, 9), 1, "line", "month", "month", 1, 3, 1)), ["Цены на марганцевую руду", "$/1% Mn смт CIF Китай"])]
                        }),
                        pageBreak(),
                        separator(),
