            ...
            sections: [
                ...
                },
                {
                    ...
                    children: [
                        ...
                        await singleTable(3, MedPriceId, GetNMonthRange(date, 9, true), 0, 1, "month"),// лом 3А
                        new docx.Paragraph({children: [new docx.PageBreak()]}),
                        h3(""),
                        ...
                        new docx.Paragraph({children: [new docx.PageBreak()]}),
                        h3(""),
                        await singleTable(5, MedPriceId, GetNMonthRange(date, 9, true), 0, 1, "month"), // чугун фоб
