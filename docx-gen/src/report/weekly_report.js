...
const { WeeklyHeaderTitle, MedPriceId, StockId, RusMonth, FontFamilyThin, PageMargins, PageZeroMargins} = require("../const");
...
const {GetMonthRange, Get2WeekRange, GetYearRange, GetNMonthRange} = require("../utils/date_ranges")
