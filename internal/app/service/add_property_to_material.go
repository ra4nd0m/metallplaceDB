...
func (s *Service) AddPropertyToMaterial(ctx context.Context, materialSourceId int, propertyName string, kind string) error {
	...
	err = s.AddMaterialProperty(ctx, materialSourceId, propertyId)
	if err != nil {
