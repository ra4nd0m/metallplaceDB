...
var InitMaterialsHorizontalWeekly = []MaterialHorizontal{
	...
	// ЗАГОТОВКА
	{"10.Сводка (неделя)",
		"Заготовка, 150*150 мм, недельная",
		"-",
		"Китай, Цзянъинь",
		"CNF",
		"$/т",
	...
	{"10.Сводка (неделя)",
		"Заготовка, 130*130 мм, недельная",
		"-",
		"Иран, Бендер Аббас",
		"FOB",
		"$/т",
	...
	{"10.Сводка (неделя)",
		"Заготовка, 120*120 мм, недельная",
		"-",
		"Турция, Искендерун",
		"CNF",
		"$/т",
	...
	{"10.Сводка (неделя)",
		"Заготовка, 100*100 мм, недельная",
		"-",
		"Непал, Раксол",
		"CNF",
		"$/т",
	...
	// СОРТОВОЙ ПРОКАТ
	{"10.Сводка (неделя)",
		"Сортовой прокат, Арматура 10-40 мм, недельная",
		"-",
		"Китай, Гонконг",
		"CNF",
		"$/т",
	...
	{"10.Сводка (неделя)",
		"Сортовой прокат, Арматура 12-32 мм, недельная",
		"-",
		"Турция, Искендерун",
		"FOB",
		"$/т",
	...
	{"10.Сводка (неделя)",
		"Сортовой прокат, Катанка 5,5-8 мм, недельная",
		"-",
		"Непал, Раксол",
		"CNF",
		"$/т",
	...
	// РУЛОННАЯ СТАЛЬ
	{"10.Сводка (неделя)",
		"Рулонная сталь, г/к рулон 2 мм, недельная",
		"-",
		"ОАЭ, Абу-Даби",
		"CNF",
		"$/т",
	...
	{"10.Сводка (неделя)",
		"Рулонная сталь, г/к рулон 1,5-3 мм, недельная",
		"-",
		"Турция, Искендерун",
		"CNF",
		"$/т",
	...
	{"10.Сводка (неделя)",
		"Рулонная сталь, г/к рулон 3-4 мм, недельная",
		"-",
	...
	{"10.Сводка (неделя)",
		"Рулонная сталь, г/к рулон 2-12 мм, недельная",
		"-",
	...
	{"10.Сводка (неделя)",
		"Рулонная сталь, г/к рулон 2-20 мм, недельная",
		"-",
		"Вьетнам, Хошимин",
		"CNF",
		"$/т",
	...
	{"10.Сводка (неделя)",
		"Рулонная сталь, г/к рулон 3-12 мм, недельная",
		"-",
		"Китай, Ричжао",
		"FOB",
		"$/т",
	...
	{"10.Сводка (неделя)",
		"Рулонная сталь, г/к рулон 1,6-2,5 мм, недельная",
		"-",
		"Южная Корея, Сеул",
		"FOB",
		"$/т",
	...
	{"10.Сводка (неделя)",
		"Рулонная сталь, х/к рулон 0.9 мм, недельная",
		"-",
		"Китай, Ричжао",
		"FOB",
		"$/т",
